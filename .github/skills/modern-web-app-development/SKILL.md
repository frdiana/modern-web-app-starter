---
name: modern-web-app-development
description: "Creates and tests one-file .NET Minimal API vertical slices with IEndpoint and FluentValidation - Brought to you by frdiana/modern-web-app-starter"
...
* A generated Modern Web App solution
